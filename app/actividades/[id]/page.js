      ...
      <section className="max-w-3xl mx-auto px-6 py-16">
        <div className="bg-white rounded-2xl shadow p-8">
          ...
          <p className="text-slate-600 leading-relaxed">
            Aquí va el contenido de la actividad {actividad.id}. Puedes reemplazar
            este texto con las instrucciones reales, embeds de formularios,
            videos, imágenes o lo que necesites.
          </p>
        </div>
